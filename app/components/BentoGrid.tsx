...
const BentoGrid = () => {
  return (
    <section id="features" className="bg-[#0D1628] py-32 px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div className="md:col-span-2 bg-[#111827] border border-[#1E293B] rounded-3xl p-10 flex flex-col justify-end min-h-90 relative overflow-hidden">
            <Image
              src="/Building.svg"
              alt=""
              fill
              ...
              aria-hidden
              className="absolute top-0 right-0 h-full w-auto opacity-[0.06] object-cover translate-x-8"
            />
          ...
          {/* Box B: Accessibility */}
          <div className="bg-[#111827] border border-[#1E293B] rounded-3xl p-8 flex flex-col justify-between min-h-90">
            <Image
            ...
            <div>
              ...
              <h3 className="font-space-grotesque text-2xl font-bold tracking-tighter text-white mb-3 leading-snug">
          ...
          <div className="md:col-span-3 bg-[#111827] border border-[#1E293B] rounded-3xl p-10 flex flex-col md:flex-row md:items-center gap-8">
