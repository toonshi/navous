      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 max-w-2xl">
            <h1 className="font-space-grotesque text-[3.2rem] md:text-[4.4rem] lg:text-[5rem] font-bold tracking-tighter text-white leading-[1.04] mb-8">
              Stop losing people
              <br />
              in the hallways.
            </h1>
            <p className="text-slate-200 text-xl md:text-2xl leading-relaxed mb-6 font-medium">
            ...
            <div className="flex flex-wrap gap-4">
              <button className="bg-primary text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-[#0fa3c4] transition cursor-pointer">
                Book a Demo
              </button>
              <button
                className="text-slate-400 px-8 py-4 rounded-full font-bold text-lg hover:text-white transition cursor-pointer"
