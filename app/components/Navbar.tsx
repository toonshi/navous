...
const Navbar = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center h-16 px-8 bg-[#13B7DA]/20 backdrop-blur-xl border-b border-white/20 shadow-sm">
