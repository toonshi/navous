...
const Navbar = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center h-16 px-8 bg-white/80 backdrop-blur-2xl backdrop-saturate-150 border-b border-slate-200 shadow-sm">
