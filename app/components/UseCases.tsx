    ...
    <section id="use-cases" className="py-32 px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          <h2 className="text-5xl md:text-6xl font-bold tracking-tight text-slate-900 mb-6 text-balance">
          ...
          <p className="text-slate-600 text-xl max-w-2xl mx-auto leading-relaxed font-medium subheading">
            Navous provides high-precision navigation where GPS fails, tailored to the specific needs of your building and your visitors.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
          <div className="flex-1 space-y-6">
            <div className="bg-slate-900 p-8 rounded-3xl text-white shadow-xl">
               <h3 className="text-3xl font-bold mb-4 subheading">Hospital Efficiency</h3>
               <p className="text-slate-400 text-lg mb-6 leading-relaxed font-medium">
                 Help patients reach Radiology, Wards, and Emergency without getting lost. Automated routing accounts for elevators and accessible paths, reducing stress for everyone.
               </p>
               <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white/5 p-4 rounded-xl border border-white/10">
                    <div className="text-[#13B7DA] font-bold text-xl">-15%</div>
                    <div className="text-xs text-slate-500 uppercase font-bold tracking-widest">Late Appointments</div>
                  </div>
                  <div className="bg-white/5 p-4 rounded-xl border border-white/10">
                    <div className="text-[#13B7DA] font-bold text-xl">31%</div>
                    <div className="text-xs text-slate-500 uppercase font-bold tracking-widest">Staff Time Saved</div>
                  </div>
               </div>
            </div>
